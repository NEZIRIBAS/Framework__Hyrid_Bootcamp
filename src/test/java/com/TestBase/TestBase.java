...
public class TestBase {
	...
	public TestBase () throws Exception {
		 ...
		 ip = new FileInputStream(System.getProperty("user.dir") +"\\src\\test\\java\\com\\TestData\\testData.properties");
			dataProp.load(ip);
	}
	...
	public WebDriver initalizeBrowserAndOpenApplication(String browserName) {
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(Util.PAGELOAD__TIME_WAIT));
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(Util.SCRIPT_TIME_WAIT));
